...
export const ConferenceSessionsList =[
 {
  key: 1,
  title: 'TRACK A: Global Integration, Trade Governance & Digital Infrastructure',
  titleColor: '#d61c25',

  subtitles: [
    {
      title: 'I. Artificial Intelligence and Digital Trade Governance',
      sessionsList: [
    ...
    {
  title: 'II. Global Supply Chain Restructuring and Resilience',
  sessionsList: [
    ...
    {
  title: 'III. Economic Integration amidst Geopolitical Fragmentation',
  sessionsList: [
...
{
  title: 'IV. FTA Implementation and New Trade Governance',
  sessionsList: [
    'Evaluating the practical impacts, utilisation rates, and early outcomes of mega-regional FTAs (e.g., CPTPP, EVFTA, RCEP).',
    'Identifying and overcoming institutional bottlenecks and regulatory constraints in FTA implementation.',
    'Reforming domestic business environments to maximise the benefits of international integration and attract high-quality investments.',
    'The evolution of "New Trade Governance" rules concerning labour standards, environmental protection, and intellectual property rights.',
  ...
  {
  key: 2,
  title: 'TRACK B: Enterprise Governance, Resilience & Entrepreneurship',

  subtitles: [
    {
      title: 'V. Family Business Sustainability and Succession Planning',
      sessionsList: [
    ...
    {
      title: 'VI. Corporate Governance and Strategic Management',
      sessionsList: [
    ...
    {
      title: 'VII. Digital Entrepreneurship and Sustainable Innovation',
      sessionsList: [
        'Adopting emerging technologies, digital platforms, and data-driven business models in resource-constrained environments.',
        'Developing sustainable business models and green resilience strategies and promoting responsible entrepreneurship.'
      ]
    },

    {
      title: 'VIII. Entrepreneurial Ecosystems, Finance, and Marketing',
      sessionsList: [
...
export const ImportantDateList = [
    ...
    },
    {
     ...
     {
        key:3,
        title:'Revised Manuscript Submission',
...
export const PatronList =[
            ...
            },
            {
                ...
                image:'/assets/images/ICATS/anuj.webp',
                name:'Prof. (Dr.) Anuj Kumar',
                detail:'Professor and Global Country Head, Rushford Business School, Switzerland'
            },
            {
                key:3,
                image:'/assets/images/CECI/huong.PNG',
                name:'Assoc. Prof. Dr. Vu Thanh Huong',
                detail:'UEB, Vietnam National University, Hanoi'
            },
            // {
            //     key:4,
