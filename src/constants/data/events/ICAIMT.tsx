...
import { ERList, SCIntlList, ConferenceSessionsList, ConvenerList, Coconvenerlist, GuestList, ImportantDateList, InternationalAdvisoryList, ProgramCommitteeList, publicationsList, PatronList, ChiefPatronList } from "./ICAIMT/ICAIMT";
      ...
      Co-Organizer (s)
          ...
          <div className="flex flex-col justify-center items-center space-y-8">
              <h2 className="text-2xl font-bold text-center">
                "International Conference on Artificial Intelligence and Mobile Technologies: Transforming Engineering, Management, Healthcare, and Humanities - 2026"
              </h2>
             ...
             <div className="max-w-[700px] h-full ">
              <img src="/assets/images/ICAIMT/campus.jpg" alt="" loading="lazy" className="w-full h-full object-content" />
             </div>
             
          </div>
          <div className="flex flex-col justify-left items-left space-y-4">
              <h2 className="text-medium font-bold text-left">
              About the Institution: S.S. Agrawal College Campus, Navsari, Gujarat, India
              </h2>
              <p className="text-medium text-justify">
               S. S. Agrawal College is a highly reputed, philanthropic educational organization, serving as the “Educational Oasis” in and around the South Gujarat region for a long time. The organization is spearheaded by the trustees, who are known for their high energy level, vision, and devotion to the cause of furthering educational opportunities for students of the new age.
In its glorious history of furthering the noble cause of education, the Agrawal Education Foundation has charted a new path by establishing the S. S. Agrawal College campus. Within a short span of time, it has emerged as a High-Tech educational hub, where students of diverse streams strive to mold their careers.
Our mission is to provide exceptional care to children while fostering each child’s intellectual, social , physical and moral development in an academic rich environment. We strive to support this environment by building a more inclusive curriculum, addressing a range of learning styles offering a wide array of diversity, efforts and programs and by participating in the wider community.
Our institution believes that success is within reach for all students. Here are the essential keys to unlocking your full potential: 1. Clear Goals, 2. Hard Work and Dedication, 3. Resilience and Adaptability, 4. Continuous Learning, 5. Strong Support Network, 6. Effective Time Management, 7. Positive Attitude and Mental Toughness, 8. Strategic Planning and Decision-Making.
              </p>
    ...
    },
    {
      ...
      children: (
        <div className="p-4 md:p-6 bg-white rounded-lg border flex flex-col space-y-6">
          ...
          <p className="text-xl font-bold">S.S. Agrawal College Campus, Navsari, Gujarat, India</p>

          <p className="text-md"><span className="font-bold">Dates:</span> 13th August (Thursday) – 14th August (Friday), 2026 | Hybrid Mode</p>
