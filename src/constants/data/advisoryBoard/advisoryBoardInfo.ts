export const advisoryBoardList =[
    ...
    },
    {
    ...
    },
     {
        ...
        role:'Associate Professor, Department of Computer Science and Information Technology, GL Bajaj Institute of Technology and Management Greater Noida.',
        info:'Dr. Birendra Kr. Saraswat is an Associate Professor in the Department of Computer Science and Information Technology, GL Bajaj Institute of Technology and Management Greater Noida. He holds an M.Tech in Computer Science & Engineering from Uttar Pradesh Technical University, Lucknow, and a Ph.D. from GLA University, Mathura. He is a Senior Member of IEEE and an active member of IAENG and IFERP. Dr. Saraswat has authored a book, contributed book chapters, published numerous research papers in Scopus-indexed journals and conferences, and holds multiple Indian patents. His notable recognitions include the Best Doctoral Thesis Award (VNU University of Economics and Business, Vietnam, 2024), Innovative Research Excellence Award (Confab 360 Degree & MAHSA University, Malaysia, 2024), Best Conference Convener Award (2023), and First Prize in Business Plan Competition – Synergy 2022 at Apeejay School of Management, New Delhi. He has served as a session chair, reviewer, keynote speaker, and judge at various national and international conferences and patent conclaves. His research interests include Machine Learning, Python Programming, Blockchain, Healthcare Informatics, and Computer Networks.',
...
{
        key:23,
        image:'/assets/images/advisoryBoard/sonia-singh.webp',
        name:'Dr. Sonia Singh',
        role:'Executive Director, Toss Global Management, UAE (Strategic Operations, Quality Excellence & Compliance, International Academic Partnerships & Institutional Growth Initiatives)',
        info:'A distinguished academician, researcher and corporate strategist with over 26 years of experience in higher education, university administration, organisational leadership, human resource transformation and international academic collaborations in India and UAE. Proven experience in institutional development, academic governance, research leadership, curriculum innovation, accreditation support, faculty development, strategic planning, and industry-academia integration. Proven track record in leading multicultural teams, establishing operational excellence frameworks, driving organisational transformation and building globally connected academic ecosystems. Executive Director, Toss Global Management, UAE (Strategic Operations, Quality Excellence & Compliance, International Academic Partnerships & Institutional Growth Initiatives) Former Group HR Director for LIN SCAN, a multinational oil and gas company servicing 56 countries, heading global HR strategy and workforce operations for 800+ employees. An experienced academician with a wide experience in teaching, research and administration in international universities and business schools.  Expertise includes university governance, curriculum innovation, research supervision, accreditation support, faculty development and industry-academia integration. Ph.D. in Applied Business Economics (specialisation in Banking, Business Finance, and Macroeconomic Policy). Research and publication contributions in AI in business, sustainability, digital transformation, leadership, finance, economics, and higher education innovation. Associate Editor, Guest Editor and Reviewer for several Scopus, ABDC, ESCI and Web of Science indexed journals with many edited books and international publications to her credit.',
        LinkedInLink:'',
    },
