...
const CheckoutAICTEShippingInterface = () => {
  ...
  useEffect(() => {
    ...
    const courseObj = serviceAICTEList.find((c) => c.value === selectedCourse);
    if (!courseObj) return;
    ...
    if (selectedCourse !== "service6") {
      ...
      if (selectedDurationObj) {
        if (watch("country") === "India") {
          finalPrice = selectedDurationObj.price ?? 0;
        } else {
        ...
        finalPrice = courseObj.duration[0]?.price || 0;
      } else {
        finalPrice = courseObj.priceNRI || 0;
      }
    }
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    <option value="" className="bg-zinc-50">
                      Select Salutation
                    </option>
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    {countriesList.map((item, i) => (
                      <option key={i} value={item.value} className="bg-zinc-50">
                        {item.name}
                      </option>
                    ))}
                  </select>
                ...
                <>
                  <div className="flex justify-between items-center gap-1 py-3 border-b border-gray-200">
                      ...
                      <div>
                        ...
                        {cart.selectedDuration && (
                          <p className="text-sm text-gray-500">
                            {cart.selectedDuration.name}
                          </p>
                        )}
                        {cart.selectedMode && (
                          <p className="text-sm text-gray-500">
                            {cart.selectedMode.name}
                          </p>
                        )}
                      </div>
                    </div>
                    <span className="font-medium">
                      {watch("country") === "India"
                        ? FormatINRCurrency(cart.purchaseAtPrice)
                        : FormatEuroCurrency(cart.purchaseAtPrice)}
                    </span>
                  </div>
                  ...
                  <div className="space-y-2 py-4">
                    <div className="flex justify-between text-gray-600">
                      ...
                      <span>
                        {watch("country") === "India"
                          ? FormatINRCurrency(subtotal ?? 0)
                          : FormatEuroCurrency(subtotal ?? 0)}
                      </span>
                    </div>
                    <div className="flex justify-between font-bold text-lg text-gray-900 pt-2 border-t border-gray-200">
                      ...
                      <span className="text-orange-600">
                        {watch("country") === "India"
                          ? FormatINRCurrency(total ?? 0)
                          : FormatEuroCurrency(total ?? 0)}
                      </span>
                    </div>
                  </div>
                </>
              ...
              <div className="space-y-4">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <label
                      htmlFor="card"
                      className="ml-3 flex flex-col md:flex-row items-start md:items-center gap-2"
                    >
...
export default CheckoutAICTEShippingInterface;
