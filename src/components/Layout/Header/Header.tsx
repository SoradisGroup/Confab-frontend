...
const isActive = (path: string) => pathname === path;
  ...
  return (
   <>
   <div className={`w-full px-4 md:px-8 py-3 fixed top-0 left-0 z-50 flex justify-between items-center transition-transform duration-500 ease-in-out ${
        showHeader ? 'translate-y-0' : '-translate-y-full'
      } bg-[#ffffff] text-white border-b border-[#f27521]/50`} > 
