...
const Career = () => {
  ...
  const submitHandler = async (data: any) => {
    ...
    toast
      .promise(
        axios.post(
          `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/career/sendMail`,
          data
        ),
        {
        ...
        <div className=" rounded-sm max-w-5xl mx-auto overflow-hidden">
          <div className="p-[20px] lg:p-[30px]">
            ...
            <p className="text-gray-600 mb-8 text-lg">
              At Confab 360 Degree, we believe in nurturing talent that drives
              innovation, collaboration, and impact. We offer a dynamic work
              environment where educators, researchers, and professionals come
              together to shape the future of learning and skill development. As
              part of our team, you’ll contribute to meaningful projects in
              research, training, and global partnerships that empower
            ...
            <form onSubmit={handleSubmit(submitHandler)} className="space-y-6">
              ...
              <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-2">
                <div className="w-full">
                  ...
                  />
                  {errors.firstName && (
                    <p className="text-sm text-red-400 px-1 pt-1">
