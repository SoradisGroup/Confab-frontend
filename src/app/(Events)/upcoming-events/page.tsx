...
const UpcomingEvent = () => {
  return (
    ...
    <div className='w-full bg-white py-10 px-[20px] md:px-[70px] max-w-7xl mx-auto flex flex-col justify-center items-center gap-5'>
        ...
        <div >
              <Link href={'/assets/file/event_files/RW.pdf'} download="RW.pdf" target='_blank' className='flex w-fit px-[40px] py-[10px] border-2 border-[#4970b3] text-white bg-transparent'><h1 className='text-md text-[#4970b3]'>Upcoming Events</h1></Link>
